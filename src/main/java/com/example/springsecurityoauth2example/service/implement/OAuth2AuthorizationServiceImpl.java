...
public class OAuth2AuthorizationServiceImpl extends BaseOAuth2Service implements OAuth2AuthorizationService {
    ...
    private OAuth2Authorization entityToOAuth2Authorization(Authorization entity) {
        RegisteredClient registeredClient = clientRegistrationRepository.findByClientId(entity.getClientId());
    ...
    private Authorization oauth2ToEntity(OAuth2Authorization authorization) throws IllegalAccessException {
        ...
        return Authorization.builder()
                ...
                .authorizedScopes(getAuthorizedScopes(authorization.getAuthorizedScopes()))
                ...
                .accessTokenScopes(getAccessTokenScopes(accessToken.getScopes()))
    ...
    private String getAuthorizedScopes(Set<String> scopes) {
    ...
    private String getAccessTokenScopes(Set<String> scopes) {
        if (CollectionUtils.isEmpty(scopes)) {
            return null;
        }
