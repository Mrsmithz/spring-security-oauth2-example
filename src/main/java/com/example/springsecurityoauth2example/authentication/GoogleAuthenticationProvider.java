...
public class GoogleAuthenticationProvider extends BaseProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!clientSupportGrantType(registeredClient)) {
    ...
    private boolean clientSupportGrantType(RegisteredClient registeredClient) {
        return Objects.isNull(registeredClient) || !registeredClient.getAuthorizationGrantTypes().contains(GoogleAuthenticationToken.AUTHORIZATION_GRANT_TYPE);
    }
}
